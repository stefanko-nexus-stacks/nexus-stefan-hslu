...
output "ssh_command" {
  ...
  value       = "cloudflared access ssh --hostname ssh-stefan-hslu.nona.company"
}
...
output "service_urls" {
  ...
  value = {
    ...
    key => "https://${service.subdomain}-stefan-hslu.nona.company"
  }
}
...
output "secrets" {
  ...
  value = {
    ...
    redpanda_schema_registry_public_url = "http://redpanda-schema-registry-stefan-hslu.nona.company:18081"
